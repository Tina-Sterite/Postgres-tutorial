...
COPY netflix
FROM 'C:\Users\steri\Desktop\PostgreSQL\Data_Files\netflix_titles.csv' DELIMITER ',' CSV HEADER;
...
TO 'C:\Users\steri\Desktop\PostgreSQL\Data_Files\popular_directors_db.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY imdb
FROM 'C:\Users\steri\Desktop\PostgreSQL\Data_Files\IMDB-Movie-Data.csv' DELIMITER ',' CSV HEADER;
select * from imdb;
